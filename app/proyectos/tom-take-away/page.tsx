...
const projectImages = [
  "/images/tom-take-away/3.png",
  "/images/tom-take-away/4.png",
  "/images/tom-take-away/5.png",
  "/images/tom-take-away/6.png",
]

export default function TomTakeAwayPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Title */}
        <h1 className="text-[#212f35] text-4xl md:text-5xl font-light mb-4 font-[family-name:var(--font-geist-sans)]">Tom Take Away</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {projectImages.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Tom Take Away - Imagen ${index + 1}`}
